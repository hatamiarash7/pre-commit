...
test_role() {
  ...
  cd "${role}" || return
    unused_variables=$(../../ansible_find_unused_variable.sh | wc -l)
    empty_files=$(../../ansible_find_empty_files.sh | wc -l)
    empty_directories=$(../../ansible_find_empty_directories.sh | wc -l)
    undefined_handlers=$(../../ansible_find_undefined_handlers.sh | wc -l)
    unquoted_values=$(../../ansible_find_unquoted_values.sh | wc -l)
  cd ../
